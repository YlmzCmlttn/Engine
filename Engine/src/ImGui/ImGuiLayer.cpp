...
#include "backends/imgui_impl_win32.cpp"  // Use Win32 backend instead of GLFW
...
namespace Engine
{
    ...
    void ImGuiLayer::onAttach() {
        ...
        // Retrieve the native Win32 window handle
        void* nativeWindow = app.getWindow().getNativeWindow();
        ENGINE_CORE_ASSERT(nativeWindow, "Win32 window is null!");
